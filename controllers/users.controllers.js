...
exports.updateUser = async (req, res) => {
  const { email } = req.params; // Obtener el email del usuario desde los parámetros de la ruta
  ...
  try {
    ...
    user.nom = nom || user.nom; // Si no se proporciona un nuevo nombre, mantener el actual
